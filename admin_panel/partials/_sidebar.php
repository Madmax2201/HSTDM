...
<div class="sidebar">
    <a href="dashboard.php" class="logo">
        ...
        <img src="../images/logo.png">
          <div class="logo-name"><span class="text-warning">E</span><span class="darkTextColor">N</span><span class="text-warning">S</span><span class="darkTextColor">S</span><span class="text-warning">M</span></div>
    </a>
    ...
    <ul class="side-menu main-side-board">
        ...
        <li><a href="kpi.php"><i class='bx bx-bar-chart-alt-2'></i>KPI Dashboard</a></li>
